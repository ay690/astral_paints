...
const Blogs = () => {
  return (
    <section className="max-w-screen-xl pt-40 mx-auto">
      <div className="container px-4 mx-auto">
        {/* Blog Heading */}
        <h2 className="mb-6 text-4xl font-bold">Our Blog</h2>
          ...
          <div className="row-span-2">
            {blogs
              ...
              .map((blog) => (
                <div
                  key={blog.id}
                  className="relative overflow-hidden rounded-lg shadow-lg h-[670px] group"
                >
                  <Image
                    src={blog.imageUrl}
                    alt={blog.title}
