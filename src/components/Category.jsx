...
const Category = ({ categories }) => {
  ...
  return (
    <motion.div
      className="relative min-h-screen px-4 py-8 mx-auto lg:py-16 lg:px-6"
      id="category-section"
      initial="hidden"
      animate="visible"
    ...
    >
      ...
      <motion.div
        className="absolute inset-y-0 left-0 w-2 bg-gradient-to-b from-red-500 to-yellow-500"
        variants={fadeIn}
      ></motion.div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          {categories && categories.length > 0 && (
            <motion.div
              className="relative mb-6 mr-0 md:mr-8 md:mb-0 group"
              variants={fadeInUp}
          ...
          <div className="flex flex-col flex-wrap flex-1 -mx-2 -mb-4 sm:flex-row">
            {categories.slice(1).map((category, index) => (
              <motion.div
                key={index}
                className="w-full px-2 mb-4 sm:w-1/2"
                variants={fadeInUp}
